...
It’s down to two kilobytes. That’s because we only have a few classes used. 
...
- Gradients, icons, animations and transitions aren’t built-in. Adding them can be complicated. 
